...
<div class="block-content">
    ...
    <div class="single-post-box">
        ...
        <div class="post-content">
            <div class="item">
                <ul class="list-posts">
                    @foreach($data_diction as $div)
                    <li>
                        <img src="{{asset('imagesdiction/'.$div->image.'')}}" height="82" alt="">
                        <div class="post-content">
                            <h2><a href="{{url('/diction/'.$div->id.'')}}">{{$div->title}}</a></h2>
                            <ul class="post-tags">
            ...
            <div class="pagination-box">
                <ul class="pagination-list">
                    {{ $data_diction->links( "pagination::default") }}
                </ul>
            </div>
            <!-- End Pagination box -->
        </div>
