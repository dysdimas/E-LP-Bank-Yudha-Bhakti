        ...
        <div class="post-content">
            <div class="item">
                <ul class="list-posts">
                    ...
                    <li>
                        <img src="{{asset('imagesbranch/'.$db->image.'')}}" height="82" alt="">
                        <div class="post-content">
                            <h2><a href="{{url('/branchnews/'.$db->id.'')}}">{{$db->title}}</a></h2>
                            <ul class="post-tags">
                                <li><i class="fa fa-clock-o"></i>{{date('l, d F Y',strtotime($db->updated_at))}}</li>
                            </ul>
                        </div>
                    </li>
                    @endforeach
            ...
            <div class="pagination-box">
                <ul class="pagination-list">
                    {{ $data_branch->links( "pagination::default") }}
                </ul>
            </div>
            <!-- End Pagination box -->
        </div>
