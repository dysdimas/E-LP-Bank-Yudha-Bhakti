...
<section class="content">
    <div class="container-fluid">
        ...
        @endif
        <!-- form start -->
        <form method="post" action="{{url('/idivision/update/'.$edit_division->id)}}" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">Divisi</label>
                    <input type="text" name="divisi" class="form-control" id="exampleInputEmail1" placeholder="Enter title" value="{{$edit_division->divisi}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Title</label>
                    <input type="text" name="title" class="form-control" id="exampleInputEmail1" placeholder="Enter title" value="{{$edit_division->title}}">
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <textarea name="description" id="post" class="form-control-file">{{$edit_division->description}}</textarea>
                </div>
            </div>
