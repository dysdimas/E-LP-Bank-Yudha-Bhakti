                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="datatable_ediction" class="table table-bordered table-responsive">
                                    <thead>
                                        <tr>
            ...
            <div class="modal-dialog modal-xl modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- form start -->
                        <form method="post" action="{{url('/cr_ediction')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="card-body">
...
<script>
    $(document).ready(function() {
        $('#datatable_ediction').DataTable({
            processing: true,
            serverside: true,
            ajax: "{{route('ajax.get.data.ediction')}}",
            columns: [{
                    data: 'title',
                    name: 'title'
                },
