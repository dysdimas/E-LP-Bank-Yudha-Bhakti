                ...
                <div class="row">
                    <div class="col">
                        <div class="card">
                            <!-- /.card-header -->
                            <div class="card-body">
                                <table id="datatable_bi" class="table table-bordered table-responsive">
                                    <thead>
                                        <tr>
            ...
            <div class="modal-dialog modal-dialog-scrollable" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <!-- form start -->
                        <form method="post" action="{{url('/upbi')}}" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            <div class="card-body">
...
<script>
    $(document).ready(function() {
        $('#datatable_bi').DataTable({
            processing: true,
            serverside: true,
            ajax: "{{route('ajax.get.data.bi')}}",
            columns: [{
                    data: 'title',
                    name: 'title'
                },
