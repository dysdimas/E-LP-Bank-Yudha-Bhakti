        ...
        <form method="post" action="{{url('/opceom/update/'.$edit_opceom->id)}}" enctype="multipart/form-data">
            ...
            <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" id="exampleInputEmail1" placeholder="Enter title" value="{{$edit_opceom->name}}">
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">Ceo Message</label>
                    <input type="text" name="ceom_message" class="form-control" id="exampleInputEmail1" placeholder="Enter title" value="{{$edit_opceom->ceom_message}}">
                </div>
                <div class="form-group">
